...
public class LabelServiceImpl implements LabelService {
    ...
    @Override
    public Boolean addLabel(LabelInput label) {
    ...
    @Override
    public Page<LabelSubstance> queryLabel(LabelForQuery labelForQuery) {
        return labelMapper.queryLabels(labelForQuery);
    }

    @Override
    public Boolean updateLabel(LabelInput label) {
        if (label.getId() == null) {
    ...
    @Override
    public Boolean deleteLabel(LabelForDelete label) {
